...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Nov-2021 às 23:54
...
(11, 'Estrutura de Dados', '10'),
(12, 'Algoritmos', '7'),
(13, 'Engenharia de Software', '8'),
(14, 'Arquitetura e Modelagem de Banco de Dados', '5'),
(15, 'Linguagem de Programação 1', '7'),
(16, 'Linguagem de Programação 2', '8'),
(17, 'Estatística Descritiva', '9'),
(18, 'Programação de Banco de Dados', '6'),
(19, 'Sistemas Operacionais', '8'),
(20, 'Padrões de Projetos de Sistemas', '7');
...
--
ALTER TABLE `fact_performance`
  MODIFY `prf_id` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
